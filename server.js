...
app.get('/public/historical/:from/:to', async (req, res) => {
  try {
    ...
    const allowedPairs = new Set([
      'AED/AUD', 'AED/BRL', 'AED/CAD', 'AED/CHF', 'AED/CNY', 'AED/EUR',
      'AED/GBP', 'AED/HKD', 'AED/ILS', 'AED/INR', 'AED/JPY', 'AED/KES',
      'AED/MXN', 'AED/NGN', 'AED/NZD', 'AED/PKR', 'AED/SAR', 'AED/THB',
      'AED/TRY', 'AED/UGX', 'AED/USD', 'AUD/AED', 'AUD/BRL', 'AUD/CAD',
      'AUD/CHF', 'AUD/CNY', 'AUD/EUR', 'AUD/GBP', 'AUD/HKD', 'AUD/ILS',
      'AUD/INR', 'AUD/JPY', 'AUD/MXN', 'AUD/NZD', 'AUD/PKR', 'AUD/SAR',
      'AUD/SGD', 'AUD/THB', 'AUD/TRY', 'AUD/USD', 'AUD/ZAR', 'BHD/EUR',
      'BHD/GBP', 'BHD/USD', 'BRL/AED', 'BRL/AUD', 'BRL/CAD', 'BRL/CHF',
      'BRL/EUR', 'BRL/GBP', 'BRL/JPY', 'BRL/SAR', 'BRL/USD', 'CAD/AED',
      'CAD/AUD', 'CAD/BRL', 'CAD/CHF', 'CAD/CNY', 'CAD/CZK', 'CAD/EUR',
      'CAD/GBP', 'CAD/GHS', 'CAD/HKD', 'CAD/HUF', 'CAD/ILS', 'CAD/INR',
      'CAD/JPY', 'CAD/KES', 'CAD/MXN', 'CAD/NGN', 'CAD/NZD', 'CAD/PKR',
      'CAD/PLN', 'CAD/RON', 'CAD/SAR', 'CAD/SGD', 'CAD/THB', 'CAD/TRY',
      'CAD/USD', 'CAD/ZAR', 'CHF/AED', 'CHF/AUD', 'CHF/BRL', 'CHF/CAD',
      'CHF/CNY', 'CHF/EUR', 'CHF/GBP', 'CHF/HKD', 'CHF/ILS', 'CHF/INR',
      'CHF/JPY', 'CHF/MXN', 'CHF/NZD', 'CHF/PLN', 'CHF/SAR', 'CHF/TRY',
      'CHF/USD', 'CHF/ZAR', 'CNY/AED', 'CNY/AUD', 'CNY/CAD', 'CNY/CHF',
      'CNY/EUR', 'CNY/GBP', 'CNY/HKD', 'CNY/JPY', 'CNY/NZD', 'CNY/SAR',
      'CNY/USD', 'CZK/CAD', 'CZK/EUR', 'CZK/GBP', 'CZK/USD', 'DKK/EUR',
      'DKK/GBP', 'DKK/USD', 'EUR/AED', 'EUR/AUD', 'EUR/BHD', 'EUR/BRL',
      'EUR/CAD', 'EUR/CHF', 'EUR/CNY', 'EUR/CZK', 'EUR/DKK', 'EUR/GBP',
      'EUR/GHS', 'EUR/HKD', 'EUR/HUF', 'EUR/ILS', 'EUR/INR', 'EUR/JPY',
      'EUR/KES', 'EUR/MUR', 'EUR/MXN', 'EUR/NGN', 'EUR/NOK', 'EUR/NZD',
      'EUR/OMR', 'EUR/PKR', 'EUR/PLN', 'EUR/QAR', 'EUR/RON', 'EUR/SAR',
      'EUR/SEK', 'EUR/SGD', 'EUR/THB', 'EUR/TRY', 'EUR/UGX', 'EUR/USD',
      'EUR/ZAR', 'GBP/AED', 'GBP/AUD', 'GBP/BHD', 'GBP/BRL', 'GBP/CAD',
      'GBP/CHF', 'GBP/CNY', 'GBP/CZK', 'GBP/DKK', 'GBP/EUR', 'GBP/GHS',
      'GBP/HKD', 'GBP/HUF', 'GBP/ILS', 'GBP/INR', 'GBP/JPY', 'GBP/KES',
      'GBP/MUR', 'GBP/MXN', 'GBP/NGN', 'GBP/NOK', 'GBP/NZD', 'GBP/OMR',
      'GBP/PKR', 'GBP/PLN', 'GBP/QAR', 'GBP/RON', 'GBP/SAR', 'GBP/SEK',
      'GBP/SGD', 'GBP/THB', 'GBP/TRY', 'GBP/UGX', 'GBP/USD', 'GBP/ZAR',
      'GHS/CAD', 'GHS/EUR', 'GHS/GBP', 'GHS/USD', 'HKD/AED', 'HKD/AUD',
      'HKD/CAD', 'HKD/CHF', 'HKD/CNY', 'HKD/EUR', 'HKD/GBP', 'HKD/ILS',
      'HKD/INR', 'HKD/JPY', 'HKD/NZD', 'HKD/SAR', 'HKD/SGD', 'HKD/THB',
      'HKD/USD', 'HUF/CAD', 'HUF/EUR', 'HUF/GBP', 'HUF/USD', 'ILS/AED',
      'ILS/AUD', 'ILS/CAD', 'ILS/CHF', 'ILS/EUR', 'ILS/GBP', 'ILS/HKD',
      'ILS/SAR', 'ILS/USD', 'INR/AED', 'INR/AUD', 'INR/CAD', 'INR/CHF',
      'INR/EUR', 'INR/GBP', 'INR/HKD', 'INR/JPY', 'INR/NZD', 'INR/SAR',
      'INR/USD', 'JPY/AED', 'JPY/AUD', 'JPY/BRL', 'JPY/CAD', 'JPY/CHF',
      'JPY/CNY', 'JPY/EUR', 'JPY/GBP', 'JPY/HKD', 'JPY/INR', 'JPY/MXN',
      'JPY/NZD', 'JPY/SAR', 'JPY/SGD', 'JPY/THB', 'JPY/USD', 'KES/AED',
      'KES/CAD', 'KES/EUR', 'KES/GBP', 'KES/SAR', 'KES/USD', 'MUR/EUR',
      'MUR/GBP', 'MUR/USD', 'MXN/AED', 'MXN/AUD', 'MXN/CAD', 'MXN/CHF',
      'MXN/EUR', 'MXN/GBP', 'MXN/JPY', 'MXN/SAR', 'MXN/USD', 'NGN/AED',
      'NGN/CAD', 'NGN/EUR', 'NGN/GBP', 'NGN/SAR', 'NGN/USD', 'NOK/EUR',
      'NOK/GBP', 'NOK/USD', 'NZD/AED', 'NZD/AUD', 'NZD/CAD', 'NZD/CHF',
      'NZD/CNY', 'NZD/EUR', 'NZD/GBP', 'NZD/HKD', 'NZD/INR', 'NZD/JPY',
      'NZD/SAR', 'NZD/SGD', 'NZD/THB', 'NZD/USD', 'NZD/ZAR', 'OMR/EUR',
      'OMR/GBP', 'OMR/USD', 'PKR/AED', 'PKR/AUD', 'PKR/CAD', 'PKR/EUR',
      'PKR/GBP', 'PKR/SAR', 'PKR/USD', 'PLN/CAD', 'PLN/CHF', 'PLN/EUR',
      'PLN/GBP', 'PLN/USD', 'QAR/EUR', 'QAR/GBP', 'QAR/USD', 'RON/CAD',
      'RON/EUR', 'RON/GBP', 'RON/USD', 'SAR/AED', 'SAR/AUD', 'SAR/BRL',
      'SAR/CAD', 'SAR/CHF', 'SAR/CNY', 'SAR/EUR', 'SAR/GBP', 'SAR/HKD',
      'SAR/ILS', 'SAR/INR', 'SAR/JPY', 'SAR/KES', 'SAR/MXN', 'SAR/NGN',
      'SAR/NZD', 'SAR/PKR', 'SAR/THB', 'SAR/TRY', 'SAR/UGX', 'SAR/USD',
      'SEK/EUR', 'SEK/GBP', 'SEK/USD', 'SGD/AUD', 'SGD/CAD', 'SGD/EUR',
      'SGD/GBP', 'SGD/HKD', 'SGD/JPY', 'SGD/NZD', 'SGD/USD', 'THB/AED',
      'THB/AUD', 'THB/CAD', 'THB/EUR', 'THB/GBP', 'THB/HKD', 'THB/JPY',
      'THB/NZD', 'THB/SAR', 'THB/USD', 'TRY/AED', 'TRY/AUD', 'TRY/CAD',
      'TRY/CHF', 'TRY/EUR', 'TRY/GBP', 'TRY/SAR', 'TRY/USD', 'UGX/AED',
      'UGX/EUR', 'UGX/GBP', 'UGX/SAR', 'UGX/USD', 'USD/AED', 'USD/AUD',
      'USD/BHD', 'USD/BRL', 'USD/CAD', 'USD/CHF', 'USD/CNY', 'USD/CZK',
      'USD/DKK', 'USD/EUR', 'USD/GBP', 'USD/GHS', 'USD/HKD', 'USD/HUF',
      'USD/ILS', 'USD/INR', 'USD/JPY', 'USD/KES', 'USD/MUR', 'USD/MXN',
      'USD/NGN', 'USD/NOK', 'USD/NZD', 'USD/OMR', 'USD/PKR', 'USD/PLN',
      'USD/QAR', 'USD/RON', 'USD/SAR', 'USD/SEK', 'USD/SGD', 'USD/THB',
      'USD/TRY', 'USD/UGX', 'USD/ZAR', 'ZAR/AUD', 'ZAR/CAD', 'ZAR/CHF',
      'ZAR/EUR', 'ZAR/GBP', 'ZAR/NZD', 'ZAR/USD',
    ]);
